...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SegWit2x backer cancel plans for bitcoin hard fork";
        CTransaction txNew;
        txNew.nTime = 1537744029;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xcd3eda1ec0cc863c3bea21cd15be10b063819541537e61a646d86c07485365f6"));
